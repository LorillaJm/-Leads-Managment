...
function KPICard({ label, value, goal, color, index }: KPICardProps) {
  return (
    <motion.div
      ...
      className={`${color} rounded-xl p-3 shadow-md hover:shadow-lg transition-all duration-300`}
    >
...
export function OverviewPanel({ 
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1, y: 0 }}
      className="bg-white/80 backdrop-blur-xl rounded-2xl border border-gray-200/50 p-3 shadow-lg h-full"
      style={{
